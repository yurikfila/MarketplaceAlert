...
export function SignupScreen() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // 'authenticated' (see AuthContext) - signup logs the account in
      // immediately, same as the backend's own auto-login design.
    } catch (error) {
      setSubmitError(error instanceof ApiError ? error.message : 'Could not create an account.');
    } finally {
      setSubmitting(false);
    }
  }
